var SHEET_SCHEMAS = {
  ...
  Gastos: ["id", "proyectoId", "etapa", "categoria", "subcategoria", "concepto", "cantidad", "unidad", "valorPresupuestado", "valorCotizado", "valorNegociado", "valorReal", "valorPagado", "saldoPendiente", "proveedor", "fecha", "formaPago", "estado", "comprobante", "observaciones", "quienCubre", "socioId", "socioNombre", "creadoPor", "creadoEn", "actualizadoEn"],
