import { api, isBackendConfigured } from "./api.js?v=control360-project-workspace-v1-20260803";
import {
  clearSession,
  ensureAuthenticated,
  getSession,
  renderLoginScreen,
  updateSessionBadge,
} from "./auth.js?v=control360-project-workspace-v1-20260803";
...
import { renderDashboard } from "./modules/dashboard.js?v=control360-project-workspace-v1-20260803";
import { renderProjects, renderProjectDetail } from "./modules/projects.js?v=control360-project-workspace-v1-20260803";
...
import { renderIncome } from "./modules/income.js?v=control360-project-workspace-v1-20260803";
import { renderExpenses } from "./modules/expenses.js?v=control360-project-workspace-v1-20260803";
import { renderPartners } from "./modules/partners.js?v=control360-project-workspace-v1-20260803";
